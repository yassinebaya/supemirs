  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const [adminRes, etudiantsRes, coursRes, paiementsRes, evenementsRes, presencesRes, professeursRes] = await Promise.all([
        fetch('http://195.179.229.230:5000/api2/admin/dashboard', { headers }),
        fetch('http://195.179.229.230:5000/api2/etudiants', { headers }),
        fetch('http://195.179.229.230:5000/api2/cours', { headers }),
        fetch('http://195.179.229.230:5000/api2/paiements', { headers }),
        fetch('http://195.179.229.230:5000/api2/evenements', { headers }),
        fetch('http://195.179.229.230:5000/api2/presences', { headers }),
        fetch('http://195.179.229.230:5000/api2/professeurs', { headers }) // ✅ جديد
      ]);
      ...
      try {
        const paiementsExpRes = await fetch('http://195.179.229.230:5000/api2/paiements/exp', { headers });
